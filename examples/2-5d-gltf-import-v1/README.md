...
Milestone 97/98 fixture for `docs/gltf-geometry-orthographic-camera-import-contract-v1.md`.
...
- M98 billboard/sprite-stack/2D-in-3D presentation metadata is normalized as `nativeScene.presentationLayers`; those layers are presentation-only and cannot mutate deterministic logic/evidence.
