...
assert.match(roadmapDoc, /Keep it a scoped capability gate, not a broad 3D\s+parity, production-engine, native-export, plugin-runtime, or Godot replacement\s+claim/);
