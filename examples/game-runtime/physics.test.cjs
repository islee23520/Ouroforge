...
assert.equal(state.physics.contacts.player[0].normal.x, 0);
assert.equal(state.physics.contacts.player[0].normal.y, -1);
assert.equal(state.physics.contactPairs[0].pairId, 'floor:player');
assert.equal(state.physics.blockedMovement.player.y, true);
...
assert.equal(state.physics.contacts.player[0].pairId, 'player:wall');
assert.equal(state.physics.contacts.player[0].otherEntityId, 'wall');
assert.equal(state.physics.contacts.player[0].normal.x, -1);
assert.equal(state.physics.contacts.player[0].normal.y, 0);
assert.equal(state.physics.blockedMovement.player.x, true);
assert.equal(state.physics.blockedMovement.player.y, false);
...
assert.equal(state.physics.contacts.player.length, 0);
assert.equal(state.physics.blockedMovement.player.x, false);
assert.equal(state.physics.blockedMovement.player.y, false);
