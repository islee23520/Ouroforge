...
- `docs/` — architecture, roadmap, evidence-fidelity/trust-boundary contracts, manifest/scaffold/scenario-pack/project-run/project-comparison/project-mutation contracts, Engine Expressiveness v2 evidence, Source Mutation Design Gate v1 outcome and preview scope, artifact write policy, public-readiness audit, and demo evidence notes.
