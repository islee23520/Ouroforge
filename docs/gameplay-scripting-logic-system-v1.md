...
- script module interfaces describe a future expansion boundary only, not an
  executable runtime, and must pass the #615 design gate / interface design gate plus the #616 sandbox/trust-boundary design gate before any runtime proposal;
