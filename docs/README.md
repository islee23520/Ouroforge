...
- [`full-3d-on-ramp-reevaluation-gate-v1.md`](full-3d-on-ramp-reevaluation-gate-v1.md) — Era Q M101 GO/DEFER design gate recording DEFER for full 3D, M102-M106 GO-gated status, two-tier state-hash-primary/perceptual-secondary evidence requirements, deterministic 3D physics re-simulation requirements, source-only clean-room boundaries, and #1/#23 open anchors.
...
- [`diagnosis-correction-intervention-feedback-loop-contract-v1.md`](diagnosis-correction-intervention-feedback-loop-contract-v1.md) — Era M M79 contract for diagnosis correction and intervention feedback as intervention-as-evidence through existing review/apply, scene/source-apply, evaluator, evidence/provenance gates with local-first CLI fallback and read + gated-write Studio only.
- [`diagnosis-correction-intervention-feedback-demo-v1.md`](diagnosis-correction-intervention-feedback-demo-v1.md) — scripted M79 demo proving optional diagnosis correction as read + gated-write intervention evidence, transparent heuristic re-attribution, rejected-correction visibility, and zero-human autonomous fallback.
- [`scenario-coverage-v70-diagnosis-correction-intervention-feedback.md`](scenario-coverage-v70-diagnosis-correction-intervention-feedback.md) — Era M M79 regression suite locking diagnosis correction as gated intervention evidence with transparent re-attribution, no raw bypass, no mandatory human dependency, and local-first two-plane boundaries.
- [`era-m-human-steerability-assessment.md`](era-m-human-steerability-assessment.md) — Era M M81 governance assessment recording active human intervention complete on merged evidence, 6/6 covered intervention classes, no raw bypass, agent-first default, and #1/#23 open anchors.
